...
comments: true
categories: [MapR, Squirrel, Hive, Drill, Impala]
---
...
6. Click "Add" and choose the jar folder we put the jars above, and select all the jars. {% img /images/20170524/blog0.png 'octopress preview' 'octopress preview' %}
...
12. Confirm the URL for hiveserver2 is correct. Modify if wrong. {% img /images/20170524/blog1.png 'octopress preview' 'octopress preview' %}
...
5. Then, click the icon of running man on upper left side or press Control-Enter, which will run the query and give you the result {% img /images/20170524/blog3.png 'octopress preview' 'octopress preview' %}
...
* Create Drivers as follows
    ...
    * Use "com.mapr.drill.jdbc41.Drive" for Class Name {% img /images/20170524/blog4.png 'octopress preview' 'octopress preview' %}
...
{% img /images/20170524/blog5.png 'octopress preview' 'octopress preview' %}
...
{% img /images/20170524/blog6.png 'octopress preview' 'octopress preview' %}
